...
import com.luoguohua.finance.system.mapper.UserDataPermissionMapper;
import com.luoguohua.finance.system.po.UserDataPermission;
...
public class UserDataPermissionServiceImpl extends ServiceImpl<UserDataPermissionMapper, UserDataPermission> implements IUserDataPermissionService {
    ...
    public String findByUserId(String userId) {
        ...
        return this.baseMapper.selectList(wrapper).stream()
                .map(permission -> String.valueOf(permission.getDeptId()))
